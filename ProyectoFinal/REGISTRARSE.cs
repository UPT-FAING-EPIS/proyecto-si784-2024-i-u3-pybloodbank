...
namespace Proyecto_Final_Blood_Bank
{
    ...
    {
        public REGISTRARSE(IDbConnection connection = null)
        {
            InitializeComponent();
        }
        ...
        {
            Register_Click(this, EventArgs.Empty);
        }
        public class UserDataAccess
        {
            ...
            private bool UserExists(string username)
            {
                ...
                using (var connection = new SqlConnection("Data Source=localhost;Initial Catalog=Hospital;Integrated Security=True"))
                {
                    string commandText = "SELECT COUNT(*) FROM Personal WHERE Usuario = @Username";
            ...
            private void InsertUser(string username, string password)
            {
                ...
                command.CommandText = "INSERT INTO Personal (Usuario, Password, estado) VALUES (@Username, @Password, 'N')";
    ...
    0x748f82ee,0x78a5636f,0x84c87814,0x8cc70208,0x90befffa,0xa4506ceb,0xbef9a3f7,0xc67178f2
        ...
        // Variable para verificar si se mostró el MessageBox
        public bool MessageBoxShown { get; private set; } = false;
        ...
        private void InsertUser(string username, string password)
        {
            using (var connection = new SqlConnection("Data Source=localhost;Initial Catalog=Hospital;Integrated Security=True"))
            {
                var command = new SqlCommand("INSERT INTO Personal (Usuario, Contrasena, estado) VALUES (@Username, @Password, 'N')", connection);
                command.Parameters.AddWithValue("@Username", username);
